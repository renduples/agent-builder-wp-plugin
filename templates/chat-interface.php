...
<div id="agentic-chat" class="agentic-chat-container" data-agentic-chat-root="1" data-agent-id="<?php echo esc_attr( $agentic_current_agent_id ); ?>">
	...
	$agentic_pm_provider     = get_option( 'agent_builder_llm_provider', 'agentic' );
	$agentic_pm_model        = get_option( 'agent_builder_model', '' );
	...
	$agentic_show_branding     = '1' !== get_option( 'agent_builder_chat_whitelabel', '1' );
	$agent_builder_show_whatsapp_cta = '1' === get_option( 'agent_builder_show_whatsapp_cta', '0' );
	?>
	...
	<?php if ( $agentic_current_agent && $agent_builder_show_whatsapp_cta ) : ?>

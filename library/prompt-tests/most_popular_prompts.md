...
| P12 | 13 | seo-optimizer | A lot of my posts are really short. Does that hurt me, and which ones are they? | list_posts_needing_seo\|get_seo_overview | full | Thin-content detection (<300-word threshold). get_seo_overview buckets thin_content at the same <300-word threshold as list_posts_needing_seo, so it genuinely surfaces the short posts and is a fair alternative (consistent with P11/P15). | seo |
